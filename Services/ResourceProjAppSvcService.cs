...
namespace AzNamingTool.Services
{
    ...
    { 
        ...
        public static async Task<ServiceResponse> GetItems()
        {
            ...
            {
                // Get list of items
                var items = await GeneralHelper.GetList<ResourceProjAppSvc>();
        ...
        public static async Task<ServiceResponse> GetItem(int id)
        {
            ...
            {
                // Get list of items
                var data = await GeneralHelper.GetList<ResourceProjAppSvc>();
        ...
        public static async Task<ServiceResponse> PostItem(ResourceProjAppSvc item)
        {
            try
            {
                ...
                // Write items to file
                await GeneralHelper.WriteList<ResourceProjAppSvc>(items);
        ...
        public static async Task<ServiceResponse> PostConfig(List<ResourceProjAppSvc> items)
        {
            try
            {
                ...
                // Write items to file
                await GeneralHelper.WriteList<ResourceProjAppSvc>(newitems);
                serviceResponse.Success = true;
            }
            catch (Exception ex)
            {
