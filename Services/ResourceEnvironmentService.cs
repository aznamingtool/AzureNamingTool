...
namespace AzNamingTool.Services
{
    public class ResourceEnvironmentService
    {
        ...
        public static async Task<ServiceResponse> GetItems()
        {
            ...
            {
                // Get list of items
                var items = await GeneralHelper.GetList<ResourceEnvironment>();
        ...
        public static async Task<ServiceResponse> GetItem(int id)
        {
            ...
            {
                // Get list of items
                var data = await GeneralHelper.GetList<ResourceEnvironment>();
        ...
        public static async Task<ServiceResponse> PostItem(ResourceEnvironment item)
        {
            try
            {
                ...
                // Write items to file
                await GeneralHelper.WriteList<ResourceEnvironment>(items);
        ...
        public static async Task<ServiceResponse> PostConfig(List<ResourceEnvironment> items)
        {
            try
            {
                ...
                // Write items to file
                await GeneralHelper.WriteList<ResourceEnvironment>(newitems);
                serviceResponse.Success = true;
            }
            catch (Exception ex)
            {
